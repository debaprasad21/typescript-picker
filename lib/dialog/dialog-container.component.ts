...
@Component({
    ...
    host: {
        ...
        '[class.dialog-container]': 'dialogContainerClass',
        '[attr.tabindex]': 'dtDialogContainerTabIndex',
        '[attr.id]': 'dtDialogContainerId',
        '[attr.role]': 'dtDialogContainerRole',
        '[attr.aria-labelledby]': 'dtDialogContainerAriaLabelledby',
        '[attr.aria-describedby]': 'dtDialogContainerAriaDescribedby',
        '[@slideModal]': 'dtDialogContainerAnimation'
    }
})
export class DialogContainerComponent extends BasePortalOutlet
    ...
    get dtDialogContainerTabIndex(): number {
        return -1;
    }

    get dtDialogContainerId(): string {
        return this._config.id;
    }

    get dtDialogContainerRole(): string {
        return this._config.role || null;
    }

    get dtDialogContainerAriaLabelledby(): string {
        return this.ariaLabelledBy;
    }

    get dtDialogContainerAriaDescribedby(): string {
        return this._config.ariaDescribedBy || null;
    }

    get dtDialogContainerAnimation(): any {
