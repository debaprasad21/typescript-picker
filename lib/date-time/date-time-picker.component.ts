...
export const DTPICKER_SCROLL_STRATEGY = new InjectionToken<
    () => ScrollStrategy
>('dtpicker-scroll-strategy');

/** @docs-private */
export function DTPICKER_SCROLL_STRATEGY_PROVIDER_FACTORY(
    overlay: Overlay
): () => BlockScrollStrategy {
...
/** @docs-private */
export const DTPICKER_SCROLL_STRATEGY_PROVIDER = {
    provide: DTPICKER_SCROLL_STRATEGY,
    deps: [Overlay],
    useFactory: DTPICKER_SCROLL_STRATEGY_PROVIDER_FACTORY
};
...
export class DateTimeComponent<T> extends DateTime<T>
    ...
    constructor(
        ...
        @Inject(DTPICKER_SCROLL_STRATEGY) defaultScrollStrategy: any,
        @Optional()
    ...
    public registerInput(input: DateTimeInputDirective<T>): void {
        if (this._dtInput) {
            throw Error(
                'A DateTimePicker can only be associated with a single input.'
            );
        }
    ...
    private openAsDialog(): void {
        this.dialogRef = this.dialogService.open(
            DateTimeContainerComponent,
            {
                ...
                paneClass: ['dt-dialog', ...coerceArray(this.panelClass)],
    ...
    private createPopup(): void {
        const overlayConfig = new OverlayConfig({
            ...
            panelClass: ['dt-popup', ...coerceArray(this.panelClass)]
        });
    ...
    private createPopupPositionStrategy(): PositionStrategy {
        return this.overlay
            ...
            .withTransformOriginOn('.dt-container')
