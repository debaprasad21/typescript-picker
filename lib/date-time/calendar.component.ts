...
@Component({
    selector: 'date-time-calendar',
    exportAs: 'dateTimeCalendar',
    templateUrl: './calendar.component.html',
    styleUrls: ['./calendar.component.scss'],
    host: {
        '[class.dt-calendar]': 'dtCalendarClass'
    },
...
export class CalendarComponent<T>
    ...
    /**
     * Bind class 'dt-calendar' to host
     * */
    get dtCalendarClass(): boolean {
        return true;
    }
            ...
            this.ngZone.onStable
                ...
                .subscribe(() => {
                    this.elmRef.nativeElement
                        .querySelector('.dt-calendar-cell-active')
                        .focus();
                });
        });
    }
