...
describe('CalendarBodyComponent', () => {
    ...
    describe('standard CalendarBodyComponent', () => {
        ...
        let refreshElementLists = () => {
            ...
            cellEls = calendarBodyNativeElement.querySelectorAll('.dt-calendar-cell');
        };
        ...
        beforeEach(() => {
            ...
            let calendarBodyDebugElement = fixture.debugElement.query(By.directive(CalendarBodyComponent));
        ...
        it('should highlight today', () => {
            let todayCell = calendarBodyNativeElement.querySelector('.dt-calendar-cell-today')!;
            expect(todayCell).not.toBeNull();
            expect(todayCell.innerHTML.trim()).toBe('3');
        });

        it('should highlight selected', () => {
            let selectedCell = calendarBodyNativeElement.querySelector('.dt-calendar-cell-selected')!;
        ...
        it('cell should be selected on click', () => {
            ...
            let todayElement =
                calendarBodyNativeElement.querySelector('.dt-calendar-cell-today') as HTMLElement;
            todayElement.click();
            fixture.detectChanges();
        ...
        it('should mark active date', () => {
            ...
            expect(cellEls[10].classList).toContain('dt-calendar-cell-active');
        });
    });
});
