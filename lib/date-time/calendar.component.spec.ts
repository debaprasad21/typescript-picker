...
@Component({
    template: `
        <date-time-calendar
                ...
                (yearSelected)="selectedYear=$event"></date-time-calendar>
    `
})
...
@Component({
    template: `
        <date-time-calendar [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [minDate]="minDate"
                                [maxDate]="maxDate"></date-time-calendar>
    `
})
...
@Component({
    template: `
        <date-time-calendar [(selected)]="selected"
                                [selectMode]="selectMode"
                                [pickerMoment]="pickerMoment"
                                [dateFilter]="dateFilter"></date-time-calendar>
    `
})
