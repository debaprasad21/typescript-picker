...
@Component({
    selector: 'date-time-multi-year-view',
    templateUrl: './calendar-multi-year-view.component.html',
    styleUrls: ['./calendar-multi-year-view.component.scss'],
    host:{
        '[class.dt-calendar-view]': 'dtCalendarView',
        '[class.dt-calendar-multi-year-view]': 'dtCalendarMultiYearView'
    },
...
export class MultiYearViewComponent<T> implements OnInit, AfterContentInit {
    ...
    @ViewChild(CalendarBodyComponent, { static: true }) calendarBodyElm: CalendarBodyComponent;
