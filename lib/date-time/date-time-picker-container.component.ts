...
import { DateTime, PickerType } from './date-time.class';
import { Observable, Subject } from 'rxjs';
import { dateTimePickerAnimations } from './date-time-picker.animations';
import {
    DOWN_ARROW,
    LEFT_ARROW,
    RIGHT_ARROW,
...
@Component({
    exportAs: 'dateTimeContainer',
    selector: 'date-time-container',
    ...
    host: {
        ...
        '[class.dt-container]': 'dtContainerClass',
        '[class.dt-popup-container]': 'dtPopupContainerClass',
        '[class.dt-dialog-container]': 'dtDialogContainerClass',
        '[class.dt-inline-container]': 'dtInlineContainerClass',
        '[class.dt-container-disabled]': 'dtContainerDisabledClass',
        '[attr.id]': 'dtContainerId',
        '[@transformPicker]': 'dtContainerAnimation',
    }
})
export class DateTimeContainerComponent<T>
    ...
    get dtContainerClass(): boolean {
        return true;
    }

    get dtPopupContainerClass(): boolean {
        return this.picker.pickerMode === 'popup';
    }

    get dtDialogContainerClass(): boolean {
        return this.picker.pickerMode === 'dialog';
    }

    get dtInlineContainerClass(): boolean {
        return this.picker.pickerMode === 'inline';
    }

    get dtContainerDisabledClass(): boolean {
        return this.picker.disabled;
    }

    get dtContainerId(): string {
        return this.picker.id;
    }

    get dtContainerAnimation(): any {
        return this.picker.pickerMode === 'inline' ? '' : 'enter';
    }

    constructor( private cdRef: ChangeDetectorRef,
                  private elmRef: ElementRef,
                  private pickerIntl: DateTimeIntl,
