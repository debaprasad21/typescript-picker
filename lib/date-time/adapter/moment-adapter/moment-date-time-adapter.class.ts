...
export class MomentDateTimeAdapter extends DateTimeAdapter<Moment> {
    ...
    constructor( @Optional() @Inject(DATE_TIME_LOCALE) private dateTimeLocale: string,
                 @Optional() @Inject(MOMENT_DATE_TIME_ADAPTER_OPTIONS) private options?: MomentDateTimeAdapterOptions ) {
        super();
