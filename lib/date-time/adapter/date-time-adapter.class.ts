...
export const DATE_TIME_LOCALE = new InjectionToken<string>(
    'DATE_TIME_LOCALE',
    {
        providedIn: 'root',
        factory: DATE_TIME_LOCALE_FACTORY
    }
);

/** @docs-private */
export function DATE_TIME_LOCALE_FACTORY(): string {
    return inject(LOCALE_ID);
}

/** Provider for DATE_TIME_LOCALE injection token. */
export const DATE_TIME_LOCALE_PROVIDER = {
